...
import { InviteUserWithNoteDialog } from './InviteUserWithNoteDialog';
            ...
            <ul className="space-y-1">
              {users.map(u => (
                <li key={u.id} className="flex items-center justify-between p-2 hover:bg-muted/50 rounded-md transition-colors">
                  ...
                  <Button size="sm" variant="secondary" onClick={() => setSelectedUser(u)} className="h-8 text-xs font-semibold">
