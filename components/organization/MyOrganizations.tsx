  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {myOrganizations.map((org) => {
        const isManager = org.ownerId === userId; // Simplified dummy check
        
        return (
          <div key={org.id} className="bg-card border border-border rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col">
            <div className="p-6 flex-1">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span><strong className="text-foreground">42</strong> Members</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <div className="bg-muted/30 border-t border-border p-4 flex justify-between items-center">
              <p className="text-xs font-medium text-muted-foreground">
                {isManager ? '12 Pending Requests' : 'Active Member'}
              </p>
